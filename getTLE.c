...
int main() {
    ...
    char res[] = response;
    char TLE1_start_index = index(res,'ST-2') + 6;
    char TLE1_end_index = TLE1_start_index + 69;
    char TLE1[69] = str.slice(TLE1_start_index, TLE1_end_index)

    char TLE2_start_index = TLE1_end_index + 2;
    char TLE2_end_index = TLE2_start_index + 69;
    char TLE2[69] = str.slice(TLE2_start_index, TLE2_end_index)
